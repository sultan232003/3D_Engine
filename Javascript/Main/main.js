const Object_Rotation_X = document.getElementById("Object_Rotation_X")
const Object_Rotation_Y = document.getElementById("Object_Rotation_Y")
const Object_Rotation_Z = document.getElementById("Object_Rotation_Z")
const Object_Move_X = document.getElementById("Object_Move_X")
const Object_Move_Y = document.getElementById("Object_Move_Y")
const Object_Move_Z = document.getElementById("Object_Move_Z")
const Camera_Rotation_X = document.getElementById("Camera_Rotation_X")
const Camera_Rotation_Y = document.getElementById("Camera_Rotation_Y")
const Camera_Rotation_Z = document.getElementById("Camera_Rotation_Z")
const Camera_Move_X = document.getElementById("Camera_Move_X")
const Camera_Move_Y = document.getElementById("Camera_Move_Y")
const Camera_Move_Z = document.getElementById("Camera_Move_Z")
...
function draw() {
    ...
    if(selected_index > -1){
        Object_Rotation_X.innerHTML = sculpture[selected_index].rotate_X
        Object_Rotation_Y.innerHTML = sculpture[selected_index].rotate_Y
        Object_Rotation_Z.innerHTML = sculpture[selected_index].rotate_Z
...
// let target = vector.create(2,2,2)
// let up = vector.create(0,1,0)
// let camera2 = vector.create(0,0,0)
// let lookdir = vector.create(0,0,1)
// let vTarget = vector.create()
// vTarget.x = camera2.x + lookdir.x
// vTarget.y = camera2.y + lookdir.y
// vTarget.z = camera2.z + lookdir.z
// print(vTarget)
...
// const Matrix_QuickInverse = (val) => // Only for Rotation/Translation Matrices
// {
...
// let mat_camera = point_at(camera2 ,vTarget , up)
// mat_camera.print_mat()
